...
class BaseEvolutionPopulation():
    ...
    def generate_children(self):
        ...
        parent_pool = self.parent_selection(self.population, self.num_children * 2, **self.parent_selection_kwargs)
    ...
    def next_generation(self):
        ...
        self.log.append(f'Population size before survival: {len(self.population)}')
        self.survival()
